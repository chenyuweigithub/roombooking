...
<hr/>
	...
	<div align="center" style="border:1px">
			...
			<s:if test="#pager.hasFirst">
				<a href="browseRoombycatalog.action?currentPage=1">首页</a>
			</s:if>
			<s:if test="#pager.hasPrevious">
				<a href="browseRoombycatalog.action?currentPage=<s:property value= "#pager.currentPage-1"/>">上一页 </a>
			</s:if>
			<s:if test="#pager.hasNext">
				<a href="browseRoombycatalog.action?currentPage=<s:property value= "#pager.currentPage+1"/>">下一页 </a>
			</s:if>
			<s:if test="#pager.hasLast">
				<a href="browseRoombycatalog.action?currentPage=<s:property value= "#pager.totalPage"/>"> 尾页 </a>
			</s:if>
			<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;
